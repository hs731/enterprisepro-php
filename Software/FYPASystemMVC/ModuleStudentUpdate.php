<?php
    ...
    //ModuleStudentUpdate.php address and access its features.
    ...
    // If Update button is pressed update the student details in the database
    if(isset($_POST['updatestudent'])){
        $moduleCtrl = new ModuleCoordinatorController();
        $moduleCtrl->updateStudent();
    }
?>
...
<html lang="en" >
    <head>
        ...
        <script type="text/javascript" src="Views/js/studentupdate.js"></script>
    ...
    <!--Jquery - open description box for table rows-->
        ...
        <div class="navigation-bar">
            ...
            <div id="editprojects">
                <h2 id="edittitle">Update a Student</h2>
                <hr>
                <h3 id="edittitle">Please select a student to update from the list below</h3><br>
                <?php
                    $deleteStudentObj = new ModuleView();
                    $deleteStudentObj->showUpdateStudentForm();
                ?>
            </div>
            <br>
            <br>
