<?php  //Haris
    ...
    if(isset($_POST['addproject'])){
        ...
        $supervisorCtrl->addProject($_SESSION['supervisorID']);
    }
?>
...
<body>
    ...
    <div id="editprojects">
        <h2 id="edittitle">Add a project</h2><br>
            <h3 id="edittitle">Fill out the form below to add a project to the system.</h3><br>
        <?php
            $supervisorView= new SupervisorView();
            //add project form
            $supervisorView->addProjectForm();
            echo "<hr>";
        ?>
    </div>
