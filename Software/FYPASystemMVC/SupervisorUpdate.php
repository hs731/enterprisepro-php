<?php  //Haris
    ...
    //Only allow signed in supervisor unto this page, redirect to loging page if session not set.
    ...
    if(isset($_POST['updateproject'])){
        $moduleCtrl = new SupervisorController();
...
<html lang="en" >
    <head>
        ...
        <script type="text/javascript" src="Views/js/supervisorjs.js"></script>
...
<body>
    ...
    <div id="editprojects">
        <h1 id="edittitle">Update a Project (originated)</h1><br> 
            <h3 id="edittitle">Select a project to update from the list below.</h3>
            <?php
                $supervisorView= new SupervisorView();
                //edit project form
                $supervisorView->updateProjectForm($_SESSION['supervisorID']);
            ?>
    </div><br><br>
    ...
    <div id="viewMyStudents" class="form">
        <form class="modal-content animate" method="post" style="color:black;">
            <span onclick="document.getElementById('viewMyStudents').style.display='none'" class="close" title="Close PopUp">&times;</span>
                <h1 style="text-align:center">My Students</h1><hr><br>
