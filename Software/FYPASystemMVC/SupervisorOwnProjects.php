...
<body>
                    ...
                    <div class="logo">University of Bradford</div>
                        <nav>
                            <ul>
                                ...
                                <li><a style="background-color: red" href="SupervisorOwnProjects.php?logout">Log out</a></li>
                            </ul>
                        </nav>
    ...
    <!-- End Slider Section -->
    <h3 id='edittitle'>View your projects</h3>
    ...
    <br><br><br>
    <?php
        $usersObject = new SupervisorView();
        $usersObject->getSupervisorProjects($_SESSION['supervisorID']); //personal projects
    ?>
