<?php  //Haris
    ...
    //ModuleSpUpdate.php address and access its features.
    ...
    // If Update button is pressed update the supervisor details in the database
    if(isset($_POST['updatesupervisor'])){
        $moduleCtrl = new ModuleCoordinatorController();
        $moduleCtrl->updateSupervisor();
    }
?>
...
<html lang="en" >
    ...
    <!--Jquery - open description box for table rows-->
        ...
        <div id="editprojects">
            <h2 id="edittitle">Update a supervisor </h2>
            <hr>
            <h3 id="edittitle">Please select a supervisor to edit from the list below</h3>
            <br>
            <?php
                $ModuleView = new ModuleView();
                $ModuleView->updateSupervisorForm();
            ?>
        </div>
